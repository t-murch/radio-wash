...
export const config = {
  matcher: [
     ...
     * - robots.txt, sitemap.xml, and the generated /icon and /apple-icon
     *   (crawler infrastructure — JSON-LD points Google at /apple-icon)
     ...
     */
    '/((?!$|_next/static|_next/image|favicon.ico|robots.txt|sitemap.xml|icon$|apple-icon$|privacy(?:/|$)|terms(?:/|$)|how-it-works(?:/|$)|guides(?:/|$)|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)',
  ],
};
