...
const PAGE_SCHEMAS = [
  howToSchema({
    name: 'How to make an Apple Music playlist clean',
    description:
      'Build a clean version of an Apple Music playlist by hand in the Music app, swapping each explicit track for its clean release and leaving out the songs that have none.',
    steps: MANUAL_STEPS,
  }),
];
      ...
      <article className="space-y-8">
        <header className="space-y-4">
          ...
          <p className="text-muted-foreground">
            ...
            let RadioWash build a clean copy for you. This guide covers both,
        ...
        <section className="space-y-3">
          ...
          <p className="text-muted-foreground">
            This works, and for a short playlist it can be done in a few
            minutes. The cost is that it is entirely per-track: there is no bulk
            operation, clean versions are easy to miss in search results, and
            the time scales with the length of the playlist. A long playlist
            means an afternoon of searching and badge-checking.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-2 pl-5 text-muted-foreground">
            <li>
              Your original playlist never has to change. Build the clean
              version as a separate playlist, whichever route you take.
            </li>
            <li>
